        ...
        <div class="row">
            <div class="col-md-12">
                <div class="px-4">
                    <el-tabs type="border-card" style="min-height:650px">
                        <el-tab-pane label="Report">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row mb-4">
                                                                <div class="col-sm-4"> <span class="rep-label">Company</span> </div>
                                                                <div class="col-sm-8 rep-box">
                                                            ...
                                                            <div class="row mb-4">
                                                                <div class="col-sm-4"> <span class="rep-label">Company Previous Ranking</span> </div>
                                                                <div class="col-sm-8 rep-box">
                                                                    <div class="rep-box">
                                                            ...
                                                            <div class="row mb-4">
                                                                <div class="col-sm-4"> <span class="rep-label">Company Current Ranking</span> </div>
                                                                <div class="col-sm-8 rep-box">
                                                                    <div class="rep-box">
                                                            ...
                                                            <div class="row mb-4">
                                                                <div class="col-sm-4"> <span class="rep-label">Industry Previous Ranking</span> </div>
                                                                <div class="col-sm-8 rep-box">
                                                                    <div class="rep-box">
                                                                        {{ info.industry_previous_num }} / {{ info.industry_previous_den }}
                                                                        <button class="btn btn-light btn-sm float-right mt-1 mr-2" @click="openAddIndustryRankModal('previous')">
                                                                            <i class="el-icon-circle-plus-outline"></i>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row mb-4">
                                                                <div class="col-sm-4"> <span class="rep-label">Industry Current Ranking</span> </div>
                                                                <div class="col-sm-8 rep-box">
                                                                    <div class="rep-box">
                                                                        {{ info.industry_current_num }} / {{ info.industry_current_den }}
                                                                        <button class="btn btn-light btn-sm float-right mt-1 mr-2" @click="openAddIndustryRankModal('current')">
                                                                            <i class="el-icon-circle-plus-outline"></i>
                                                                        </button>
                                                                    </div>
                                                                </div>
                            ...
                            <b-row class="mt-5">
                                <b-col md="5">
                                    <div class="card">
                                        <div class="card-header py-0">Phone-In comment</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <textarea 
                                                    v-model="phone_in_comment.comment"
                                                    class="form-control" rows="5" :readonly="phoneInCommentReadonly">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-6">
                                                    ...
                                                    @click="phoneInCommentReadonly = !phoneInCommentReadonly">edit</button>
                                                </div>
                                                <div class="col-md-6">
                                                       <button class="btn btn-success btn-sm float-right"
                                                       @click="updatePhoneInComment">update</button> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <b-col md="5" offset-md="2">
                                    <div class="card">
                                        <div class="card-header py-0">Walk-In comment</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <textarea 
                                                    v-model="walk_in_comment.comment"
                                                    class="form-control" rows="5" :readonly="walkInCommentReadonly">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-6">
                                                    <button class="btn btn-primary btn-sm"
                                                    @click="walkInCommentReadonly = !walkInCommentReadonly">edit</button>
                                                </div>
                                                <div class="col-md-6">
                                                       <button class="btn btn-success btn-sm float-right"
                                                       @click="updateWalkInComment">update</button> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 bg-light">
                                    ...
                                    <div class="row py-2 px-2" style="border:solid 2px #9fa2a3; border-radius:10px; overflow-x:auto">
                                        ...
                                        <div class="col-md-5 col-sm-12 col-xs-12" style="min-width:300px">
                                            <div class="row py-2" style="background-color:#fff; border-radius:10px">
                                                <div class="col-md-12">
                                                    <div class="row">
                                            ...
                                            <div class="row mt-4 py-2" style="background-color:#fff; border-radius:10px">
                                                <div class="col-md-12">
                                                    <div class="row mt-3">
                                                        <div class="col-sm-6" style="text-align:center">
                                                            <span>Current</span>
                                                    ...
                                                    <div class="row py-2">
                                                        <div class="col-sm-12 text-center">
                                                            <span style="font-wight:bold; font-size:22px">Industry</span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="row">
                                                                <div class="col-sm-12 text-center">
                                                                    <span style="font-weight:bold; font-size:20px">{{ info.industry_current_num }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-12 text-center">
                                                                    <span style="font-size:20px">(of {{ info.industry_current_den }})</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="row">
                                                                <div class="col-sm-12 text-center">
                                                                    <span style="font-weight:bold; font-size:20px">{{ info.industry_previous_num }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-12 text-center">
                                                                    <span style="font-size:20px">(of {{ info.industry_previous_den }})</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card-body">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr></tr>
                                                    <tr>
                                                        <td style="font-weight:bold">PHONE-IN COMMENT</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            {{ phone_in_comment.comment }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="card-body">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr></tr>
                                                    <tr>
                                                        <td style="font-weight:bold">WALK-IN COMMENT</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            {{ walk_in_comment.comment }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                    ...
                    <b-modal ref="addIndustryRankModal"
                        :title="new_industry_rank.title"
                        centered
                        :no-close-on-backdrop="true"
                        :no-close-on-esc="true"
                        :hide-footer="true"
                    >
                        <b-form @submit.prevent="createIndustryRank">
                            <b-form-group label="rank">
                                <b-form-input
                                    type="number"
                                    v-model="new_industry_rank.num"
                                    required
                                    min="0"
                                    autocomplete="off"
                                >
    ...
    export default {
        ...
        data() {
            return {
                ...
                phoneInCommentReadonly: true,
                walkInCommentReadonly: true,
                phone_in_comment: {comment:'', type:'phone'},
                walk_in_comment: {comment: '', type:'walk'}
            }
        },
        methods: {
            updateWalkInComment: function() {
                let walkInData = (this.report || {}).walk_in_entries[0] || {};
                let typeId = walkInData.id
                let reportId = this.info.id;
                axios.put(`api/reports/${reportId}/comment`, this.walk_in_comment)
                    .then(result=> {
                        let res = result || {};
                        if(res.code == 0) {
            ...
            updatePhoneInComment: function() {
                let phoneInData = (this.report || {}).phone_in_entries[0] || {};
                let typeId = phoneInData.id;
                let reportId = this.info.id;
                axios.put(`api/reports/${reportId}/comment`, this.phone_in_comment)
                    .then(result=> {
                        let res = result;
                        if(res.code == 0) {
                            location.reload(true);
            ...
            fetchReport: function() {
                ...
                axios.get(`/api/reports/${reportId}`)
                    .then((result)=> {
                        ...
                        this.walk_in_comment.comment = (reportData.report || {}).walk_in_comment;
                        this.phone_in_comment.comment = (reportData.report || {}).phone_in_comment
                    })
                    .catch((err)=> {
                        this.isLoading = false;
                    })
            ...
            openAddIndustryRankModal: function(type) {
                this.new_rank = {};
                this.new_industry_rank.title = type;
                this.$refs.addIndustryRankModal.show();
            },
            createRank: function() {
                this.isLoading = true;
            ...
            createIndustryRank: function() {
                this.isLoading = true;
                axios.put(`/api/reports/${this.report.report.id}/add-industry-rank`, this.new_industry_rank)
                    .then((res)=> {
                        this.isLoading = false;
                        location.reload(true);
                    })
